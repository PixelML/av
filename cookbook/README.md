...
| [Sanitized receipts](receipts/README.md) | Completed ASR/baseline, caption smoke/abort, and both incompatible cap probes | No media, transcript/caption corpus, credentials, upload URIs, or private routes; baseline question and returned answer/rationale retained |
