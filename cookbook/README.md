...
| [Sanitized receipts](receipts/README.md) | Completed ASR/baseline, caption smoke/abort, and incompatible cap probes including the restored-route retry | No media, transcript/caption corpus, credentials, upload URIs, or private routes; baseline question and returned answer/rationale retained |
...
260 completion tokens against `max_completion_tokens=32`. The guard therefore
stopped before ingestion or query. There is **no completed AV Grok+Jev
